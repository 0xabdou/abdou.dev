...
import AbletonDropdownMenu from "../../components/fep/ableton/ableton-dropdown-menu";
...
import AbletonSection, {
  AbletonSectionLink,
} from "../../components/fep/ableton/ableton-section";
import AbletonStickyMenu from "../../components/fep/ableton/ableton-sticky-menu";
...
const Ableton = () => {
  ...
  return (
    <div
      className={`w-full h-screen max-w-screen-xl text-black 
    ...
    >
      ...
      />
      <div className="relative flex flex-col w-full bg-white font-poppins">
        ...
        >
          ...
          <div className="hidden lg:flex lg:grow items-center">
            {["Live", "Push", "Link", "Shop", "Packs", "Help", "More +"].map(
              (item) => (
                <a
            ...
            <div className="grow" />
            <a className="font-medium m-4 text-[#0000ff]" href={"#try-live"}>
              Try Live for free
            </a>
            <a className="font-medium m-4 text-xs" href={"#login-or-register"}>
              Login or register
            </a>
          </div>
        </header>
        <AbletonStickyMenu scrollRef={scrollRef} />
        <div className="flex relative h-screen max-h-[600px] w-auto mx-[10%] mb-24">
          <Image
            className="z-0"
        ...
        <AbletonSection
          header={
            <>
              ...
              <AbletonSectionLink label="Link" /> - hardware for music creation
              and performance. With these products, our community of users
          ...
          footer={
            <div className="flex items-center justify-between relative w-full h-[55vw] max-h-[900px] px-[10%]">
              <div
                className="absolute right-0 w-[55vw] h-[55vw] bg-[#fbffa7]
              ...
              <div className="relative w-[30vw] h-[25vw] max-w-[430px] max-h-[300px]">
                <Image
                  className="z-10"
        ...
        <AbletonSection
          ...
          footer={
            ...
            >
              <div className="absolute left-0 w-[58vw] max-w-[900px] h-full bg-[#b6ffc0]" />
              <div className="flex flex-col h-full justify-around">
                <div className="relative w-[35vw] h-[25vw] max-w-[500px] max-h-[370px]">
                  <Image
                    className="z-10"
              ...
              <div className="relative w-[40vw] h-[40vw] max-w-[444px] max-h-[444px]">
                <Image
                  className="z-10"
        ...
        <AbletonSection
          ...
          footer={
            <div className="relative w-[82vw] h-[44vw] max-w-[1200px] max-h-[750px]">
              <Image
                className="z-10"
        ...
        <AbletonSection
          ...
          paragraph={
            <>
              <p className="pb-4">
                ...
                personally and professionally, and we strive to create a wealth
          ...
          footer={
            <div className="flex items-center justify-between relative w-full h-[55vw] max-h-[900px]">
              <div
                className="absolute w-[70vw] h-full bg-[#d5b3ff]
              left-1/2 -translate-x-1/2
              max-w-[1000px]"
              />
              <div className="relative w-[35vw] h-[25vw] ml-[5%] max-w-[500px] max-h-[370px]">
                <Image
                  className="z-10"
              ...
              <div className="relative w-[38vw] h-[38vw] max-w-[600px] max-h-[600px]">
                <Image
                  className="z-10"
        ...
        <AbletonSection
          ...
          footer={
            <div className="flex flex-col xl:flex-row items-center xl:items-start w-[80%]  ">
              <div className="relative w-[80vw] h-[38vw] max-w-[600px] max-h-[600px] flex-shrink-0">
                <Image
                  className="z-10"
