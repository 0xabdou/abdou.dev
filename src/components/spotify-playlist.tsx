        ...
        <PlaylistRow key={`${name}_row_${idx}`}>
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-center">
              ...
              {/*The artists*/}
              <div className="flex text-sm leading-4 line-clamp-1">
...
const PlaylistRow = ({ children, header, url }: PlaylistRowProps) => {
  ...
  if (!actualChildren)
    actualChildren = ["#", "TITLE", "ALBUM", "DATE ADDED", "DATE"];
  ...
  const actualRow = (
    <div className="flex">
      ...
      <div className="grow pr-2">{actualChildren[1]}</div>
  ...
  return isHeader ? (
    ...
    >
      <div className="flex items-center m-2 mt-4 h-12">
        ...
        <div className="flex justify-center items-center h-12 w-12 ml-auto mr-4">
          <a
