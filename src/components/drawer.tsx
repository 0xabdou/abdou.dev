...
const Drawer = (props: DrawerProps) => {
  ...
  return (
    <div
      className="h-screen w-screen absolute z-40 flex overflow-hidden">
      <div
        className={`flex flex-col w-80 max-w-full h-screen bg-knight 
      ...
      >
        <div
          className="flex justify-between items-center
            ...
            pl-4 py-2 border-b border-white border-opacity-10"
        >
          Abdou's Corner
